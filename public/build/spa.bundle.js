...
/***/ (function(module, exports, __webpack_require__) {
	...
	Vue.http.interceptors.push(function (request, next) {
	    request.headers.set('Authorization', _auth2.default.getAuthorizationHeader());
	    next();
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var afterLogin = function afterLogin() {
	    _resources.User.get().then(function (response) {
	        return _localStorage2.default.setObject(USER, response.data);
	    });
	};
	exports.default = {
...
/***/ (function(module, exports) {
	...
	module.exports = "\n<div id=\"app\">\n    <header>\n\n    </header>\n\n    <main>\n        <router-view></router-view>\n    </main>\n\n    <footer class=\"page-footer\">\n        <div class=\"footer-copyright\">\n            <div class=\"container\">\n                {{ year }} <a class=\"grey-text text-lighten-4\">Ctweb</a>\n            </div>\n        </div>\n    </footer>\n\n</div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-0195d11c/Dashboard.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
